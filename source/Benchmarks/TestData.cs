...
public class SalesRecord
{
	...
	[CsvHeader("Region")]
	[ExcelReader.Core.Parser.ExcelColumn("Region")]
	...
	[CsvHeader("Country")]
	[ExcelReader.Core.Parser.ExcelColumn("Country")]
	...
	[CsvHeader("Item Type")]
	[ExcelReader.Core.Parser.ExcelColumn("Item Type")]
	public string ItemType { get; set; }
	[Name("Sales Channel")]
	[DataMember(Name = "Sales Channel")]
	[ExcelColumnName("Sales Channel")]
	[ColumnMap(Name = "Sales Channel")]
	[CsvHeader("Sales Channel")]
	[ExcelReader.Core.Parser.ExcelColumn("Sales Channel")]
	public string SalesChannel { get; set; }
	[Name("Order Priority")]
	[DataMember(Name = "Order Priority")]
	[ExcelColumnName("Order Priority")]
	[ColumnMap(Name = "Order Priority")]
	[CsvHeader("Order Priority")]
	[ExcelReader.Core.Parser.ExcelColumn("Order Priority")]
	...
	[ExcelReader.Core.Parser.ExcelColumn("Order Date")]
	...
	[CsvHeader("Order ID")]
	[ExcelReader.Core.Parser.ExcelColumn("Order ID")]
	...
	[CsvHeader("Ship Date")]
	[ExcelReader.Core.Parser.ExcelColumn("Ship Date")]
	...
	[ExcelReader.Core.Parser.ExcelColumn("Units Sold")]
	public int UnitsSold { get; set; }
	[Name("Unit Price")]
	[DataMember(Name = "Unit Price")]
	[ExcelColumnName("Unit Price")]
	[ColumnMap(Name = "Unit Price")]
	[CsvHeader("Unit Price")]
	[ExcelReader.Core.Parser.ExcelColumn("Unit Price")]
	...
	[CsvHeader("Unit Cost")]
	[ExcelReader.Core.Parser.ExcelColumn("Unit Cost")]
	...
	[ExcelReader.Core.Parser.ExcelColumn("Total Revenue")]
	public decimal TotalRevenue { get; set; }
	[Name("Total Cost")]
	[DataMember(Name = "Total Cost")]
	[ExcelColumnName("Total Cost")]
	[ColumnMap(Name = "Total Cost")]
	[CsvHeader("Total Cost")]
	[ExcelReader.Core.Parser.ExcelColumn("Total Cost")]
	public decimal TotalCost { get; set; }
	[Name("Total Profit")]
	[DataMember(Name = "Total Profit")]
	[ExcelColumnName("Total Profit")]
	[ColumnMap(Name = "Total Profit")]
	[CsvHeader("Total Profit")]
	[ExcelReader.Core.Parser.ExcelColumn("Total Profit")]
